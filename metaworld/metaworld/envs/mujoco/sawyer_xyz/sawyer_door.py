...
from metaworld.envs.mujoco.sawyer_xyz.parameters import door_params as param
from metaworld.envs.mujoco.cameras import *
...
class SawyerDoorEnv(SawyerXYZEnv):
    def __init__(
        ...
        self.camera = create_sawyer_camera_init(distance=0.6)
        self.initialize_camera(self.camera)
