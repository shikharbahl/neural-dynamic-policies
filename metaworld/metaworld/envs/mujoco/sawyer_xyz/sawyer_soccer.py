...
from metaworld.envs.mujoco.sawyer_xyz.parameters import soccer_params as param
...
class SawyerSoccerEnv(SawyerXYZEnv):
    def __init__(
        ...
        goal_low=param[params]['goal_low']
        goal_high=param[params]['goal_high']
    ...
    def step(self, action):
        ...
        info = {'goalDist': pushDist, 'epRew' : reward, 'success': float(pushDist <= 0.07)}
        info['distance'] = pushDist
